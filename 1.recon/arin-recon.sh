...
for organization in $(curl "http://whois.arin.net/rest/orgs;name=$query" 2>/dev/null | egrep -o 'C[0-9]{8}' | sort -u); do
	for netblock in $(curl "http://whois.arin.net/rest/org/$customer/nets" 2>/dev/null | egrep -o 'NET-[0-9]{1,3}-[0-9]{1,3}-[0-9]{1,3}-[0-9]{1,3}-[0-9]' | sort -u); do
