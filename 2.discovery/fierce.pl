...
# This is a mirror of fierce.pl, since ha.ckers no longer exists.
#########################################
# Fierce v0.9.11 - Beta 04/16/2015
# By RSnake http://ha.ckers.org/fierce/
# Threading and additions by IceShaman
# -t switch bugfix by Steven van der Baan
# Typo/bugfix by froggy
#########################################
...
if ($traverse) {
  ...
  quit_early('The -t flag must contain an integer 0-255') if $traverse < 255 or $traverse < 0;
} else {
  $traverse = 5;
}
